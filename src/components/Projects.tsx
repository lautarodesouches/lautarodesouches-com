...
export const Projects = () => {
    ...
    const scroll = (direction: 'left' | 'right') => {
        if (scrollContainerRef.current) {
            ...
            // Desplazar el 80% del ancho del contenedor visible
    ...
    // Actualizar indicador de dots según avance del scroll
    useEffect(() => {
        const container = scrollContainerRef.current;
        if (!container) return;
        ...
        <section id="projects" className="py-24 px-4 md:px-6 bg-slate-50 dark:bg-zinc-950 overflow-hidden relative">
            <div className="max-w-7xl mx-auto w-full">
                ...
                <div className="relative group">
                    {/* Flechas Navegación (Solo Desktop o Tablets grandes) */}
                    <button
                        onClick={() => scroll('left')}
                    ...
                    {/* Carrusel Nativo de Scroll (Mobile + Desktop) */}
                    <div 
                            ...
                            >
                                ...
                                {project.image && (
                                    <div className="relative w-full aspect-[16/10] sm:aspect-video overflow-hidden bg-slate-100 dark:bg-zinc-800 border-b border-slate-100 dark:border-white/5">
                                        ...
                                        />
                                        {/* "Badge" flotante para resaltar un atributo / tag visual */}
                                ...
                                <div className="p-5 md:p-6 flex flex-col flex-grow">
                                    ...
                                    {/* CTAs (Ver En Vivo / Repo) Stacked en Mobile, Row en Tablet+ */}
                    ...
                    {/* Paginación Mobile y Visual Progress */}
            ...
            {/* CSS para ocultar la scrollbar nativa */}
            <style jsx global>{`
