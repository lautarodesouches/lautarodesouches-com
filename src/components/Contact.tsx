                            ...
                            <li>
                                ...
                                >
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <p className="text-xs font-mono text-slate-400 dark:text-gray-500 uppercase tracking-wider">
                                                Email
                                            </p>
                                    ...
                                    <span className="text-sm text-brand dark:text-tech opacity-0 group-hover:opacity-100 transition-opacity">
                                        Enviar →
                                    </span>
                                </a>
                            </li>
