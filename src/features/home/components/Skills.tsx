                                ...
                                <div key={idx}>
                                    ...
                                    <ul className="flex flex-wrap gap-2">
                                        {group.techs.map((tech) => (
                                            <li key={tech}>
                                                <span className="px-3 py-1.5 text-sm font-medium rounded-md bg-brand/5 dark:bg-tech/10 text-brand dark:text-tech border border-brand/20 dark:border-tech/30 block">
                                                    {tech}
                                                </span>
                                            </li>
                                        ))}
                        ...
                        <div>
                            ...
                            <ul className="flex flex-wrap gap-2">
                                {skills.secondary.items.map((item) => (
                                    <li key={item}>
                                        <span className="px-3 py-1.5 text-sm font-medium rounded-md bg-slate-50 dark:bg-white/5 text-slate-600 dark:text-gray-400 border border-slate-200 dark:border-white/10 block">
                                            {item}
                                        </span>
                                    </li>
                                ))}
